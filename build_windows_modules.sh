...
function main
{
  ...
  local winexclude_root_path=${CPP_ROOT_PATH:-"./windows/winexclude"}
  ...
  build_solution "$winexclude_root_path" "winexclude.sln"
  ...
  copy_outputs $winexclude_root_path "winexclude.dll"
